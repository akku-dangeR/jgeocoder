...
class RegexLibrary{
  ...
  private static class UsAddressesData{    
    ...
    static{
      ...
      UNIT_MAP.put("APARTMENT","APMT");
      UNIT_MAP.put("BASEMENT","BSMT");
      UNIT_MAP.put("BUILDING","BLDG");
      UNIT_MAP.put("DEPARTMENT","DEPT");
      UNIT_MAP.put("FLOOR","FL");
      UNIT_MAP.put("FLOOR","F");
      UNIT_MAP.put("FRONG","FRNT");
      UNIT_MAP.put("HANGAR","HNGR");
      UNIT_MAP.put("LOBBY","LBBY");
      UNIT_MAP.put("LOBBY","LBY");
      UNIT_MAP.put("LOT","LOT");
      UNIT_MAP.put("LOT","LT");
      UNIT_MAP.put("LOWER","LOWR");
      UNIT_MAP.put("NUMBER","NUM");
      UNIT_MAP.put("NUMBER","#");
      UNIT_MAP.put("NUMBER","NO");
      UNIT_MAP.put("OFFICE","OFC");
      UNIT_MAP.put("OFFICE","OFIC");
      UNIT_MAP.put("OFFICE","OFFC");
      UNIT_MAP.put("PIER","PIER");
      UNIT_MAP.put("PENTHOUSE","PH");
      UNIT_MAP.put("PO BOX","PBOX");
      UNIT_MAP.put("PO BOX","PB");
      UNIT_MAP.put("POBOX","PBOX");
      UNIT_MAP.put("POBOX","PB");
      UNIT_MAP.put("PO BOX","POBX");
      UNIT_MAP.put("POBOX","POBX");
      UNIT_MAP.put("BOX","BX");
